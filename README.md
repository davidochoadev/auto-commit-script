...
Dopo il `npm link`, il comando `commit` sarà disponibile in qualsiasi cartella.
...
4. Verifica che il link esista: `which commit` (deve mostrare un path tipo `…/node/v…/bin/commit`).
